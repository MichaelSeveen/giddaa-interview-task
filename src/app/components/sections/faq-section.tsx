...
export function FAQSection() {
  return (
    <section className="w-full bg-white py-20">
      <div className="container mx-auto flex flex-col px-4 md:px-6 lg:px-20">
        <div className="flex flex-col gap-6 mb-10">
          <SectionBadge label="FAQs" />
          <h2 className="font-bold text-[2rem] leading-12.5 lg:text-[2.5rem] lg:leading-17 lg:w-227.5 lg:h-13.25">
