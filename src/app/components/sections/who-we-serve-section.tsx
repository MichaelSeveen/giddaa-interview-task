...
function ServiceCard({ card }: { card: ServiceCardData }) {
  return (
    <div className="sticky top-[10vh] transition-all md:top-[14vh]">
      <div
        className={`flex flex-col-reverse items-center md:flex-row ${card.bgColor} rounded-[40px] lg:rounded-[5rem] px-4 py-6 lg:p-10 gap-10`}
      >
        ...
        <div className="relative h-[204px] w-[331px] lg:h-[450px] lg:w-full lg:flex-1">
          <Image
            src={card.imageSrc}
            alt="Hero Image"
            fill
...
export function WhoWeServeSection() {
  return (
    <section className="w-full bg-[#FFEED0] pb-[120px] pt-20 md:pt-18.75">
      <div className="container mx-auto flex flex-col px-4 md:px-6 lg:px-20 gap-10">
        <div className="flex flex-col gap-6 lg:w-192.25">
          <SectionBadge label="Who we serve" variant="light" />
          <h2 className="font-bold text-[2rem] leading-12.5 lg:text-[2.5rem] lg:leading-17 h-[99px] w-[361px] lg:w-full lg:h-13.25">
          ...
          <p className="lg:hidden text-[1.25rem] leading-8.5 text-[#4B4B4B] w-[361px]">
